...
### Check if VMware Components are Rebooted Cleanly
print "\n\n----------------------- Signal Check on VMware Components -----------------------\n";
...
if( $is_error == 1 ){
	print "\n[TEST_REPORT]\tFAILED TO CONTACT SOME VMWARE MACHINES !!!\n\n";
	exit(1);
};
...
if( $is_checked == 1 ){
	...
	print "\n[TEST_REPORT]\tALL VMWARE MACHINES ARE UP AND RUNNING\n\n";
}else{
